        ...
        <div className = 'prototype01-section'>
            <div className = 'prototype01-section01'>
                <div className = 'prototype01'>
                        <img  className = 'lang-image' src = 'https://img.icons8.com/color/100/000000/html-5.png'></img>
                        <p className = 'lang-para'>HTML</p>
                </div>
                <div className = 'prototype01'>
                        <img  className = 'lang-image' src = 'https://img.icons8.com/color/100/000000/css3.png'/>
                        <p className = 'lang-para'>CSS</p>
                </div>
                <div className = 'prototype01'>
                        <img  className = 'lang-image' src = 'https://img.icons8.com/color/100/000000/javascript.png'/>
            ...
            <div className = {width <= 768 ? 'prototype01-section02' :'prototype01-section02'} >
                <div className = {width <= 768 ? 'prototype01' :'prototype-change01'}>
                        <img  className = 'lang-image' src = 'https://img.icons8.com/color/100/000000/python.png'/>
                        <p className = 'lang-para'>PYTHON</p>
                </div>
                <div className = {width <= 768 ? 'prototype01' : 'prototype-change02'}>
                        <img  className = 'lang-image' src = 'https://img.icons8.com/color/100/java-coffee-cup-logo--v1.png'/>
